...
lazy val YARNJobManager = project.in(file("JobManager")).dependsOn(YARNCommon).
	settings(
		name := "YARNJobManager",
		version := "1.0",
		scalaVersion := "2.11.4",
...
lazy val YARNNodeManager = project.in(file("NodeManager")).dependsOn(YARNCommon,YARNJobManager).
	settings(
